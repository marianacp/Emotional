				...
				<div class="inner-content">
					...
					<!--albums-->
								...
								<div class="tittle-head">
									<h3 class="tittle">Perguntas Frequentes </h3>
									<div class="clearfix"> </div>
								</div>
					...
					<div class='question'>
								  ...
								  <label for='question-5'>Qual a diferença entre o perfil verificado de um artista e qualquer outro perfil?</label>
 									 <div class='answer'>
  										O perfil verificado de um artista leva para sua página de discografia.
  									<p></p>
 										 Outros perfis não terão outras páginas.
								...
								<div class='question'>
  									<input type='checkbox' id='question-6'>
  										<label for='question-6'>O que é uma página de discografia?</label>
  											<div class='answer'>
  												  É a página onde as músicas de um artista ficam dentro do Emotional.
  											</div>
								</div>
								...
								<div class='question'>
  									<input type='checkbox' id='question-7'>
 										 <label for='question-7'>Como faço para colocar minha música no Emotional?</label>
  											<div class='answer'>
  												 Basta ter um perfil de artista verificado. 
 											 </div>
								</div>
								...
								<div class='question'>
  								...
  								<label for='question-8'>Não sei minhas informações de login.</label>
  									<div class='answer'>
   								 Todas as contas do Emotional estão associadas a um endereço de e-mail ou uma conta do Gmail. Siga os passos abaixo para ver qual opção usar para fazer login na sua conta. 
 								<p></p>
 									<p></p>
