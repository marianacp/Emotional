...
=======
            <label for="nome">Nome da M�sica</label>
...
=======
		  <p> 
            <label for="emocao">Como voc� definiria esta m�sica?</label>
>>>>>>> parent of 7c66a1a... Update FRONT
...
=======
   		...
   		<label for="musica">Muito bem, ${sessionScope.usuarioLogado.nome}, agora envie a sua m�sica.</label>
          
          <p>N�o esque�a do formato MP3!</p>
>>>>>>> parent of 7c66a1a... Update FRONT
