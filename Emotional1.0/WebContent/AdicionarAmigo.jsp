...
<html>
<head>
<title>Emotional | Adicionar Amigo </title>
				...
				<div class="inner-content">
					...
					<!--albums-->
								...
								<div class="tittle-head">
									<h3 class="tittle">Adicionar Amigo </h3>
									<div class="clearfix"> </div>
								</div>
<div id="adicionarAmigo">
    ...
    <div class="shadow">
	 ...
	 <div class="shadow">
	  ...
	  <p class="linked">  
        ...
        <div class="col-sm-8">
          <p><a href="#">Francisco de Lima</a></p>
