...
=======
                        ...
                        <li>
                            <a href="table.html">
                                <i class="fas fa-table"></i>AprovaÁıes</a>
                        </li>
                        <li>
                            <a href="form.html">
...
=======
                                <i class="fas fa-tachometer-alt"></i>Dashboard</a>
>>>>>>> parent of 3ebcc77... Altera√ß√µes
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body">
                                                ...
                                                <div class="account-dropdown__item">
                                                    <a href="#">
                                                        <i class="zmdi zmdi-settings"></i>Configura√ß√£o</a>
                                                </div>
                                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <p>Ol· ${sessionScope.usuarioLogado.nome}</p>
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Bloquear / Desbloquear usu√°rio</h3>
