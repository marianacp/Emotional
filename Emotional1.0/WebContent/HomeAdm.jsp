				...
				<div class="container-fluid">
					<ul class="navbar-mobile__list list-unstyled">
						<li class="has-sub"><a class="js-arrow" href="#"> <<<<<<<
								HEAD <i class="fas fa-tachometer-alt"></i>Músicas
						</a>
							<ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
								<li><a href="index.html">Músicas</a> <i
								...
								<li><a href="AprovacaoMusica.jsp"> <i
										class="fas fa-table"></i>Aprova��es
								</a></li>
			...
			<div class="menu-sidebar__content js-scrollbar1">
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						...
						<li class="active"><a href="HomeAdm.jsp"> <i
								class="fas fa-chart-bar"></i>Bloqueio e Desbloqueio de Usuario
						</a></li>
						<li><a href="AprovacaoMusica.jsp"> <i
								class="fas fa-table"></i>Aprovacao de M�sica
						</a></li>
						<li><a href="form.html"> <i class="far fa-check-square"></i>Forms
						</a></li>
						<li><a href="#"> <i class="fas fa-calendar-alt"></i>Calendar
										...
										<div class="account-dropdown js-dropdown">
											<div class="info clearfix">
												...
												<div class="content">
													...
													<span class="email">johndoe@emotional.com</span>
												</div>
											</div>
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="table-responsive table-responsive-data2">
								<p>Ol�, ${sessionScope.usuarioLogado.nome}, essas s�o as
									buscas encontradas:</p>
								<div id="buscarMusica">
