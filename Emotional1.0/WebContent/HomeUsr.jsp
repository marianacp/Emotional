...
<!-- Bootstrap -->
<link rel="stylesheet" type="text/css"  href="css/cssUsr/bootstrap.css">
<link rel="stylesheet" type="text/css" href="fonts/font-awesome/css/font-awesome.css">

<!-- Stylesheet
    ================================================== -->
<link rel="stylesheet" type="text/css"  href="css/cssUsr/style.css">
<link rel="stylesheet" type="text/css" href="css/ncssUsr/ivo-lightbox/nivo-lightbox.css">
<link rel="stylesheet" type="text/css" href="css/cssUsr/nivo-lightbox/default.css">
...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="#page-top">Emotional</a> </div>
    
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#HomeUsr.jsp" class="page-scroll">Home</a></li>
        <li><a href="#restaurant-menu" class="page-scroll">Menu</a></li>
        <li><a href="#Playlists.jsp" class="page-scroll">Playlists</a></li>
        <li><a href="#team" class="page-scroll">Chefs</a></li>
        <li><a href="#FaleConosco" class="page-scroll">Ajuda</a></li>
      </ul>
    </div>
    <!-- /.navbar-collapse --> 
  </div>
...
<script type="text/javascript" src="js/jsUsr/jquery.1.11.1.js"></script> 
<script type="text/javascript" src="js/jsUsr/bootstrap.js"></script> 
<script type="text/javascript" src="js/jsUsr/SmoothScroll.js"></script> 
<script type="text/javascript" src="js/jsUsr/nivo-lightbox.js"></script> 
<script type="text/javascript" src="js/jsUsr/jquery.isotope.js"></script> 
<script type="text/javascript" src="js/jsUsr/jqBootstrapValidation.js"></script> 
<script type="text/javascript" src="js/jsUsr/contact_me.js"></script> 
<script type="text/javascript" src="js/jsUsr/main.js"></script>
</body>
</html>
